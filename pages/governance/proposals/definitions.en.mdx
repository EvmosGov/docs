...
Proposal Phases are denoted as: `[P1]`, `[P2]`, `[P3]`, `[P4]` for the 4-phases, and `[PASSED]`, `[REJECTED]`, `[DEFERRED]` for proposals in the other stages. Refer to the [Proposal Lifecycle](/governance/proposals/lifecycle) page for more information on proposal lifecycle phases. 
...
The following proposal identification tags do not have to be in the title. A Governance Council member will attach one when the proposal is formalized in `Phase 2: ECP Formalization`. 
...
- **Governance Proposals**: `[#-ECP]`
- **Workstreams Related Proposals**: `[#-ECP-WS]`
