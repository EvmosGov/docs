...
# The Evmos Community Proposal Lifecycle
    ...
    <Box sx={{ minWidth: 275, mt: 6, padding: 0, pt: 1 }}>
...
![Proposal Lifecycle](/lifecycle-flowchart.png)
...
Core developers are not bound to the ECP Framework for network and protocol related proposals. It is expected, however, that thorough testing and due dilligence is performed by the developers for all network upgrades.
