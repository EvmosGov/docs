...
All proposal titles on Commonwealth must also include the Proposal Phase as denoted by: `[P1]`, `[P2]`, `[P3]`, `[P4]`, `[PASSED]`, `[REJECTED]`, `[DEFERRED]`. You can refer to the [Proposal Lifecycle](/governance/proposals/lifecycle) page for details. 

The following proposal identification tags do not have to be in the title. A Governance Council member will attach one when the proposal is formalized in **Phase 2: ECP Formalization**. These tags are for internal tracking and organization purposes. Check the [Proposal Submission Guidelines](/governance/proposals/submission) for more insight into the different types of proposals. 
